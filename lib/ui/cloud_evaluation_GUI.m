...
handles.RCS_Profi = transpose(nanmean(elSig, 2)) .* lidarData.height .^ 2;
handles.VDR_Profi = transpose(nanmean(lidarData.CH2_PC, 2) ./ nanmean(lidarData.CH1_PC, 2)) .* str2double(handles.gainRatio_tb.String);
